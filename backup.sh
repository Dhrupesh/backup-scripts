...
echo "INSTANCE=$INSTANCE HOST=$HOST ROOTSYNC=$ROOTSYNC INST_PATH=$INST_PATH SSH_USER=$SSH_USER PG_PORT=$PG_PORT
PG_VERSION=$PG_VERSION DB_BACKUPPATH_IN=$DB_BACKUPPATH_IN"
